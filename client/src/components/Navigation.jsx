    ...
    <nav className="fixed top-0 left-0 right-0 bg-gray-900 text-white px-6 py-4 shadow-lg z-50">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-6 items-center">
          ...
          <Link to="/inventory" className="hover:text-blue-300 font-semibold">
            Inventory
          </Link>
          <Link to="/support" className="hover:text-blue-300 font-semibold">
            Support
          </Link>
          <Link to="/favorites" className="hover:text-blue-300 font-semibold">
            Saved
          </Link>
          <Link to="/orders" className="hover:text-blue-300 font-semibold">
            My Orders
          </Link>
        </div>
